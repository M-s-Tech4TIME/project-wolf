...
echo ""
echo "Done. Shims installed at ${TARGET_BIN_DIR}/; ${TARGET_LIB_DIR}/wolf-*/ dirs created."
echo ""
echo "These dirs are empty after this script. Phase 5.9 / 5.10 .deb"
echo "package post-install will:"
echo "  1. Create a Python venv at ${TARGET_LIB_DIR}/wolf-server/.venv"
echo "     and install the wolf-server + wolf-cert + wolf-common packages."
echo "  2. Create a Python venv at ${TARGET_LIB_DIR}/wolf-database/.venv"
...
echo "     at ${TARGET_LIB_DIR}/wolf-dashboard/.next/standalone/."
echo ""
echo "Until then, the shims (which hardcode the production /usr/lib/"
echo "paths regardless of where they're installed) correctly detect"
echo "the missing venvs and exit with a helpful error message naming"
