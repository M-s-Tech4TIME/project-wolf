...
| **5.0c-b** | UI layout: persistent + resizable + text-wrapping Evidence panel · collapsible Conversations sidebar · fixed message input · chat vertical scroll · user-avatar dropdown replacing the session-id chip. | ⏳ not started | — |
